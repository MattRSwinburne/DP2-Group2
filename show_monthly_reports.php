  ...
  <body>
    ...
    <aside name="export_report_all" id="export_report_all">
      <form method="post" action="process_form.php">
        <input type="submit" name="form_type" id="form_type" value="CSVExportMonth"/>
      </form>
    </aside>
      ...
      <?php
        ...
        $query2 = "SELECT sales.id, stock.item_name, stock.brand, sales.qty, sales.total, sales.date_time
                  ...
                  WHERE sales.id != '0'
                  GROUP BY MONTH(sales.date_time)
                  ORDER BY MONTH(sales.date_time)";
        ...
        if (mysqli_num_rows($result) > 0 && mysqli_num_rows($result2) > 0) {
          ...
          <h2> Sales ordered and grouped by month </h2>
          <table>
            <tr>
              <th>Item</th>
              <th>Brand</th>
